    ...
    try {
        ...
        if ((0, authUser_1.checkAuthUser)(authPage)) {
            ...
            try {
                ...
                const teacherListData = await page.evaluate(services_1.getGroupListData);
                ...
                await browser.close();
                if (result.length) {
                    await (0, services_1.setTeacherDB)(JSON.stringify(result), startParse);
                }
                setTimeout(exports.parseTeacher, constants_1.SCHEDULE_UPDATE_INTERVAL);
                return result;
            }
            catch (e) {
                await page.close();
...
exports.parseTeacher = parseTeacher;
//# sourceMappingURL=parseTeacher.js.map